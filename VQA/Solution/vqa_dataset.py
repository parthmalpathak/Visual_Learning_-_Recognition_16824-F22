...
class VQADataset(Dataset):
    ...
    def __init__(self, image_dir, question_json_file_path,
        ...
        self._get_ques_ids = self._vqa.get_ques_ids()
    ...
    def __getitem__(self, idx):
        ...
        """
        q_idx = self._get_ques_ids[idx]
        # q_idx = int(q_idx)
        # print("This is the Index:", q_idx)
        q_anno =  self._vqa.load_qa(ids = q_idx)[0] # load annotation
        # print(q_anno)
        # print(self._vqa.qqa[q_idx])
        q_str = self._vqa.qqa[q_idx]['question']  # question in str format
